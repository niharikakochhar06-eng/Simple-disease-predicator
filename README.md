...
2. Features
Rule-Based Logic: Utilizes a predefined internal dictionary (DISEASE_SYMPTOMS) to map symptoms to conditions.
...
Ensure the main file is present in the directory: disease_predictor.py.
